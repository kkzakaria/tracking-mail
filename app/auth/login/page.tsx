...
export default function LoginPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-600 to-purple-700 flex items-center justify-center relative overflow-hidden p-4">
      ...
      <div className="flex w-full max-w-sm flex-col gap-6 relative z-10">
        ...
        <div className="flex items-center gap-2 self-center font-medium">
          <div className="p-3 bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl shadow-lg">
        ...
        <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-3xl overflow-hidden shadow-lg">
          <LoginForm />
        </div>
      </div>
    </div>
